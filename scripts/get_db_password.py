...
def main():
    ...
    try:
        ...
        print(
            f"   MEMORY_DB_URL=postgresql://tsdbadmin:PASSWORD@{parts}:33500/tsdb?sslmode=require"
        )
        ...
        print("1. List your services to find the service ID")
        print("2. Get service details with password")
        print("3. Update MEMORY_DB_URL in .env with the password")
        return 1
